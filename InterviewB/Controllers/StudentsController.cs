...
namespace InterviewB.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,BirthDate,Qualification,Grade,Center,Governorate,Address,Weight,Height,FatherJob,Type,Fitness,GeneralLook,CulturalLevel,TransportationOpinion,TrainingStaffOpinion,AttendanceDay")] Student student)
        {
            if (ModelState.IsValid)
            {
